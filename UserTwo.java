...
public class UserTwo implements ActionListener, Runnable {
    ...
    UserTwo() {
        ...
        // ImageIcon i1 = new ImageIcon(getClass().getResource("icons/mirzapur.png"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/RV logo.jpg"));
        ...
        try {
            Socket socket = new Socket("localhost", 11005); // Changed port number to 2004
